...
const Footer = () => {
  const links = [
    ...
    },
    {
      ...
      href: "..assets/Shivansh_Resume.pdf", 
      style: "rounded-br-md",
      download: true,
    },
    {
      ...
      child: (
        <>
          Instagram <FaInstagram size={50} className="px-2" />
        </>
      ),
      href: "https://www.instagram.com/shivanshpal31/",
      style: "rounded-br-md",
    },
  ];
  return (
    <div className=" pb-10 lg:pb-2 bg-gradient-to-b from-gray-800 to-black w-full">
      <div className="w-full grid grid-cols-5 sm:grid-cols-5 gap-0 text-center py-8 px-12 sm:px-0">
